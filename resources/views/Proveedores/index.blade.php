...
<a href="{{ route('Proveedores.create')}}" class="btn btn-info btn-sm"> Crear proveedor</a>
...
<h2 class="titulo-productos" style="color: #0056b3; font-size: 30px;">Proveedores Agregados</h2>
        ...
        <table class="table table-bordered table-sm" id="tablaProveedores">
            ...
            <tbody>
                ...
                <tr class="fila-destacada">
                    ...
                    <td>
                        <a href="{{ route('Proveedores.edit', $proveedor->id_proveedores) }}" class="editar-icon" title="Editar"><i class="fas fa-edit"></i></a>
                    </td>
                    <td>
                        <form action="{{ route('Proveedores.destroy', $proveedor->id_proveedores) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este proveedor?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-link eliminar-icon" title="Eliminar"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </td>
                </tr>  
                @endforeach
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <img src="{{ asset('images/ayuda/proveedoresagregados.png') }}" class="img-fluid" alt="Imagen de Ayuda">
            </div>
        </div>
    </div>
</div>
