...
<div class="form-group">
    ...
    <input type="text" name="cedula" class="form-control" style="color: #000; height: 35px;" value="{{old('cedula')}}"> <!-- Cambio de color -->
    @error('cedula')
...
<div class="form-group">
    ...
    <input type="text" name="nombre" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
    @error('nombre')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
<div class="form-group">
    ...
    <input type="text" name="apellido" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
    @error('apellido')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
<div class="form-group">
    ...
    <input type="number" name="telefono" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
    @error('telefono')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
<div class="form-group">
    <label for="estado" style="color:#0056b3;">Estado:</label> <!-- Cambio de color -->
    <select name="estado" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
...
<div class="form-group">
    ...
    <input type="text" name="ruc" class="form-control" style="color: #000; height: 35px;" value="{{old('ruc')}}"><!--metodo value sirve para preservar datos aunque se recargue <!-- Cambio de color -->
    @error('ruc')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
<div class="form-group">
    ...
    <input type="text" name="razonsocial" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
    @error('razonsocial')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
<div class="form-group">
    ...
    <input type="text" name="direccion" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
    @error('direccion')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
...
<div class="form-group">
    ...
    <input type="text" name="email" class="form-control" style="color: #000; height: 35px;"> <!-- Cambio de color -->
    @error('email')
        <span class="text-danger text-error">{{$message}} </span>
    @enderror
</div>
