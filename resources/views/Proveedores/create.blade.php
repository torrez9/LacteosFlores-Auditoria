    ...
    <form action="{{route('Proveedores.store')}}" method="POST">    
        ...
        <div class="box-body">
            ...
            <div class="box-footer">
                ...
                <a href="{{route('Proveedores.index')}}" class="btn btn-danger btn-sm">Cancelar</a>
                ...
                <button type="submit" class="btn btn-info btn-sm">Nuevo</button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="{{ asset('images/ayuda/proveedorcreate.png') }}" class="img-fluid" alt="Imagen de Ayuda">
                    </div>
                </div>
            </div>
        </div>
