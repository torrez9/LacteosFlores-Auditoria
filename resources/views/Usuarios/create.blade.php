...
@section('content')
<div class="main-container" style="background-color: #F2F2F2; padding: 20px;">
    <div class="box box-solid box-primary rounded">
        <div class="box-header with-border">
        <center>
            <h2 class="box-title titulo-facturacion" style="color: #0056b3; font-size: 28px;">Gestión de Usuarios</h2>
        </center>
        </div>
        ...
        <form action="{{route('Usuario.store')}}" method="POST">    
            ...
            <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="{{route('Usuario.index')}}" class="btn btn-danger btn-sm">Cancelar</a>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <img src="{{ asset('images/ayuda/usuarioscreados.png') }}" class="img-fluid" alt="Imagen de Ayuda">
                        </div>
                    </div>
                </div>
            </div>
