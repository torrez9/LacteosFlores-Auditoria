...
<input type="text" name="descripcion" class="form-control" placeholder="Descripción del producto" value="{{$producto->descripcion}}">
<label>Cantidad:</label>
<input type="number" name="cantidadprod" class="form-control" placeholder="Cantidad" value="{{$producto->cantidadprod}}">
...
<input type="number" name="precioventa" class="form-control" placeholder="Precio de venta" value="{{$producto->precioventa}}">
<div class="form-group">
    <label for="proveedor" class="form-label">Selecciona un proveedor:</label>
    <input type="text" class="form-control" id="proveedor" name="proveedor"
        placeholder="Escribe el nombre del proveedor" value="{{$producto->idproveedor}}">
