...
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#imagenAyuda" style="margin-left: 20px;">Ayuda</button>
@stop


@section('content')
    <section id="datagrid">
        <h2 class="titulo-productos" style="color: #0056b3; font-size: 30px;">Productos Agregados</h2>
            ...
            <table class="table table-bordered table-sm" id="tablaProductos">
                ...
                <tbody class="tbody2">
                    ...
                    <tr class="fila-destacada">
                        ...
                        <td>
                            <a href="{{ route('Productos.edit', $producto->id_producto) }}" class="editar-icon"><i class="fas fa-edit"></i></a>
                        </td>
                        <td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <img src="{{ asset('images/ayuda/productosagregados.png') }}" class="img-fluid" alt="Imagen de Ayuda">
                </div>
            </div>
        </div>
    </div>
