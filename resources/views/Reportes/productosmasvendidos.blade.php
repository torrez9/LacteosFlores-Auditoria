...
@section('content')
    <form action="{{ route('ReportePdfProductosMasVendidos') }}" method="GET" id="reporteForm">
        <div class="card">
            <div class="card-header" style="background-color: #3498db; color: white; border-top-left-radius: 8px; border-top-right-radius: 8px; padding: 10px;">
                <h3 class="card-title">Reporte de Productos más Vendidos</h3>
            </div>
            <div class="card-body">
                <div class="form-row">
                ...
                <div class="table-responsive">
                    <table id="productosmasvendidos" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>Id Producto</th>
                                <th>Descripción</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#productosmasvendidos').DataTable({
                "paging": false,
                "info": false,
