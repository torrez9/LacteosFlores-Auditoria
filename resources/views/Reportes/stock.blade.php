...
@section('content')
    <form action="{{ route('ReporteStock') }}" method="GET" id="reporteForm">
        <div class="card">
            <div class="card-header" style="background-color: #3498db; color: white; border-top-left-radius: 8px; border-top-right-radius: 8px; padding: 10px;">
                <h3 class="card-title">Reporte de los Productos</h3>
            </div>
            <div class="card-body">
                <div class="form-row">
                    ...
                    <table id="stock" class="table table-bordered table-hover">
                        ...
                        <tfoot>
                            <tr style="background-color: #f2f2f2; color: #333; font-weight: bold;">
                                ...
                                <td id="total_precio_venta">$ 0.00</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        $(document).ready(function() {
            var table = $('#stock').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    $('#total_precio_venta').text('C$ ' + total.toFixed(2)); // Mostrar el total en el footer
                }
            });
            ...
            $('#total_precio_venta').text('C$ ' + initialTotal.toFixed(2));
        });
    </script>
@stop
